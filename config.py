...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002082701021"))
...
FORCE_PIC = os.environ.get("FORCE_PIC", "https://i.ibb.co/275nqJbp/e91b51b6f9e9.jpg") 
